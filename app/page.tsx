    ...
    <CaseStudyShell
      hero={
        <HomeHero
          ...
          figuresSource="MediSapience in production · published on medisapience.com"
        />
      }
    >
      ...
      <section id="contact" className={styles.spacious} aria-labelledby="contact-title">
        <div className={styles.contact} data-reveal="settle">
          <div className={styles.glow} aria-hidden="true" />
          <h2 id="contact-title" data-split>
            <span>Have a product in mind?</span> Let’s turn the real workflow into a product.
          </h2>
          ...
          <p className={styles.contactNote}>Preview email: {person.email} · replace before launch</p>
        </div>
      </section>
    </CaseStudyShell>
  );
